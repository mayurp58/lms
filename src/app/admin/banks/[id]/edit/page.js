    ...
    return (
      <DashboardLayout requiredRole="super_admin">
        <div className="text-center">
          <p className="text-red-600">{error || 'Bank not found'}</p>
          <Link href="/admin/banks" className="text-blue-600 hover:text-blue-800 mt-2 inline-block">
            ← Back to Banks
          </Link>
        </div>
      </DashboardLayout>
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            Update information for {bank.name}
          </p>
        </div>
          ...
          <div className="px-4 py-5 sm:p-6">
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-end space-x-3 pt-6 border-t">
                    ...
                    >
                    {loading ? 'Saving...' : (bank ? 'Update Bank' : 'Create Bank')}
                    </button>
                </div>
            </form>
          </div>
